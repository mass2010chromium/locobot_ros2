...
rm -f fastrtps_profile.xml cyclonedds_profile.xml set_env.sh teleop.py tilt_pan.py restart_ros2.sh start_vnc.sh
...
ln -s "$SCRIPT_DIR/start_vnc.sh" start_vnc.sh
